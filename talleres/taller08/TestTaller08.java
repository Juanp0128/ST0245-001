...
import java.util.*;
    ...
    public class TestTaller08 {
        ...
        public static void ejercicio2(){
            Queue<String> cola1;
            String[] a = {"Roberto","Aurelio","Gonzalo","Juliana"};
            cola1=toQueue(a);
            Taller08.cola(cola1);
        }
        ...
        public static boolean ejercicio3(){
            ...
            a=14;
            s1 = "3 5 * 12 + 13 -";
            a1 = Taller08.polaca(s1);

            b=-172;
            s2 = "12 5 * 232 -";
            b1 = Taller08.polaca(s2);

            c=884;
            s3 = "34 2 * 13 *";
            c1 = Taller08.polaca(s3);

            d=1260;
            s4 = "67 3 * 21 - 7 *";
            d1 = Taller08.polaca(s4);
